...
def run_grid_vector_magnitude_experiment(datasets):
    ...
    # template_bb_config = {'use_grid': True, 'num_s': 300, 'num_acts': 10}
...
def run_basic_mesh_encoder_experiment(datasets):
    ...
    bb_config = {'num_s': 256, 'num_acts': 1}
    # bb_config = {'use_mesh': True, 'num_s': 300, 'num_acts': 15}
    ...
    # bb_config = {'use_mesh': True, 'num_s': 400, 'num_acts': 20}
    # clf_name1 = '20/400 neurons'
    # classifier_configs.append((clf_name1, bb_config))

    # bb_config = {'use_mesh': True, 'num_s': 500, 'num_acts': 25}
    # clf_name1 = '25/500 neurons'
    # classifier_configs.append((clf_name1, bb_config))

    # bb_config = {'use_mesh': True, 'num_s': 300, 'num_acts': 15, 'num_epochs': 8}
    # clf_name1 = '8 Epochs'
    # classifier_configs.append((clf_name1, bb_config))
